...
// La pauta entrega un arreglo propio; si lo consigues, reemplaza este archivo
// completo respetando la forma { nombre, comunas: [] } y el resto sigue igual.
...
const REGIONES = [
    ...
    {
        nombre: "Tarapacá",
        comunas: ["Alto Hospicio", "Camiña", "Colchane", "Huara", "Iquique",
            "Pica", "Pozo Almonte"]
    },
    {
        nombre: "Antofagasta",
        comunas: ["Antofagasta", "Calama", "María Elena", "Mejillones", "Ollagüe",
            "San Pedro de Atacama", "Sierra Gorda", "Taltal", "Tocopilla"]
    },
    {
        nombre: "Atacama",
        comunas: ["Alto del Carmen", "Caldera", "Chañaral", "Copiapó",
            "Diego de Almagro", "Freirina", "Huasco", "Tierra Amarilla", "Vallenar"]
    },
    {
        nombre: "Coquimbo",
        comunas: ["Andacollo", "Canela", "Combarbalá", "Coquimbo", "Illapel",
            "La Higuera", "La Serena", "Los Vilos", "Monte Patria", "Ovalle",
            "Paihuano", "Punitaqui", "Río Hurtado", "Salamanca", "Vicuña"]
    },
    {
        nombre: "Valparaíso",
        comunas: ["Algarrobo", "Cabildo", "Calera", "Calle Larga", "Cartagena",
    ...
    },
    {
        ...
        comunas: ["Chépica", "Chimbarongo", "Codegua", "Coinco", "Coltauco",
            ...
            "Pichidegua", "Pichilemu", "Placilla", "Pumanque", "Quinta de Tilcoco",
            "Rancagua", "Rengo", "Requínoa", "San Fernando", "San Vicente",
            "Santa Cruz"]
    },
    {
        nombre: "Maule",
        comunas: ["Cauquenes", "Chanco", "Colbún", "Constitución", "Curepto",
    ...
    {
        nombre: "Ñuble",
        comunas: ["Bulnes", "Chillán", "Chillán Viejo", "Cobquecura", "Coelemu",
    ...
    {
        nombre: "Biobío",
        comunas: ["Alto Biobío", "Antuco", "Arauco", "Cabrero", "Cañete",
    ...
    {
        nombre: "La Araucanía",
        comunas: ["Angol", "Carahue", "Cholchol", "Collipulli", "Cunco",
    ...
    {
        nombre: "Los Ríos",
        comunas: ["Corral", "Futrono", "La Unión", "Lago Ranco", "Lanco",
            "Los Lagos", "Máfil", "Mariquina", "Paillaco", "Panguipulli",
            "Río Bueno", "Valdivia"]
    },
    {
        nombre: "Los Lagos",
        comunas: ["Ancud", "Calbuco", "Castro", "Chaitén", "Chonchi",
            ...
            "Puqueldón", "Purranque", "Puyehue", "Queilén", "Quellón", "Quemchi",
            "Quinchao", "Río Negro", "San Juan de la Costa", "San Pablo"]
    },
    {
        nombre: "Aysén del General Carlos Ibáñez del Campo",
        comunas: ["Aysén", "Chile Chico", "Cisnes", "Cochrane", "Coyhaique",
...
function nombresDeRegiones() {
    return REGIONES.map(function (region) {
        return region.nombre;
    });
}

function comunasDeRegion(nombreRegion) {
    const region = REGIONES.find(function (una) {
        return una.nombre === nombreRegion;
    });

    return region ? region.comunas : [];
}

function regionDeComuna(nombreComuna) {
    const region = REGIONES.find(function (una) {
        return una.comunas.indexOf(nombreComuna) !== -1;
    });
